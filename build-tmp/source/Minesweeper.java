...
public class MSButton{
	...
	public void drawButton(){
		...
		if(isFlagged){
			noStroke();
			fill(139,69,19);
			rect(x+theLength/3.5f, y+theLength/2, theLength/6.25f, theLength/2);
			fill(165,42,42);
			rect(x+theLength/3.5f, y+theLength/3.5f, theLength/2, theLength/3.1f);
		}
		//draws text if the button is pressed
		if(isPressed){
			fill(255);
			textSize(theLength/1.5f);
